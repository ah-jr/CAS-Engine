...
//==============================================================================
constructor TCasDsThread.Create(CreateSuspended: Boolean);
begin
...
//==============================================================================
procedure TCasDsThread.CreateBuffer;
var
...
//==============================================================================
procedure TCasDsThread.SetBuffersLoop;
var
  dwPlayPos  : Cardinal;
  dwWritePos : Cardinal;
  bHalved    : Boolean;
...
//==============================================================================
procedure TCasDsThread.PopulateBuffer(nOffset : Cardinal);
var
  ptrAudio1     : Pointer;
  ptrAudio2     : Pointer;
